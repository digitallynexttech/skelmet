...
export const COLOURWAYS: Colourway[] = [
  {
    ...
    sku: "SKM-BLZ",
    hex: "#FF5A1F",
    blurb: "Hi-vis, unmissable, glows under a warm bulb. The one everybody photographs.",
  ...
  },
  {
    ...
    sku: "SKM-OLV",
    hex: "#8A9A5B",
    blurb: "Muted, tactical, disappears into a dark wall until you look twice.",
  ...
  },
  {
    ...
    sku: "SKM-GHT",
    hex: "#C8CED6",
    blurb: "Concrete-toned and clean. The one that survives a flatmate veto.",
