  ...
  return (
    <Section>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4 lg:grid-rows-[repeat(3,220px)]">
        {/* Hero tile */}
        <article className="relative col-span-2 min-h-[300px] overflow-hidden rounded-card border border-blaze/30 lg:row-span-2 lg:min-h-0">
          <Image
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8">
            <h3 className="mb-2.5 font-display text-[28px] leading-[1.04] text-bone uppercase sm:text-[38px]">
              Printed to order,
              <br />
              not stockpiled
            </h3>
        ...
        <article className="flex flex-col justify-between gap-6 rounded-card border border-white/[0.09] bg-carbon p-5 sm:p-6">
          <Boxes className="size-[26px] text-acid" strokeWidth={1.6} />
          <div>
            <h3 className="mb-2 font-display leading-[1.08] text-[20px] text-bone uppercase sm:text-[23px]">
              Glove hook
            </h3>
            <p className="text-[13px] leading-[1.52] text-ash sm:text-[13.5px]">
        ...
        <article className="flex flex-col justify-between gap-6 rounded-card border border-white/[0.09] bg-carbon p-5 sm:p-6">
          <Clock className="size-[26px] text-violet" strokeWidth={1.6} />
          <div>
            <h3 className="mb-2 font-display leading-[1.08] text-[20px] text-bone uppercase sm:text-[23px]">
              10-min fit
            </h3>
        ...
        <article className="relative col-span-2 min-h-[200px] overflow-hidden rounded-card border border-white/[0.09]">
          <Image
          ...
          <div className="absolute inset-y-0 left-0 flex w-[68%] flex-col justify-center gap-2 p-5 sm:p-7">
            <div className="flex items-center gap-2.5">
              <Wind className="size-[22px] shrink-0 text-ember" strokeWidth={1.6} />
              <h3 className="font-display leading-[1.08] text-[20px] text-bone uppercase sm:text-[24px]">
                Dries the liner out
              </h3>
            </div>
            <p className="text-[13px] leading-[1.52] text-[#c9c6d4] sm:text-[13.5px]">
              Off the floor and open to the air, so the padding isn&apos;t damp when you leave in the
              morning.
            </p>
          </div>
        </article>
        ...
        <article className="flex flex-col justify-between gap-6 rounded-card border border-magenta/30 bg-[linear-gradient(160deg,rgb(255_61_154_/_0.12),transparent_62%)] bg-carbon p-5 sm:p-6">
          <Gift className="size-[26px] text-magenta" strokeWidth={1.6} />
          <div>
            <h3 className="mb-2 font-display leading-[1.08] text-[20px] text-bone uppercase sm:text-[23px]">
              Actual gift
            </h3>
