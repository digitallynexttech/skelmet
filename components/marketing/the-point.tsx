...
export function ThePoint() {
  return (
    ...
    >
      ...
      <h2 className="mb-5 font-display text-[42px] leading-[1.0] text-bone uppercase sm:text-[56px] xl:text-[72px]">
        You spent 20k
        <br />
        on that lid.
      </h2>
      <p className="mb-5 max-w-[480px] text-[16px] leading-[1.62] text-ash text-pretty sm:text-[17.5px]">
        Then you put it on the floor next to the shoe rack. The visor gets scratched, the liner stays
        damp, and the whole thing smells like a gym bag by Thursday.
      </p>
      <p className="mb-8 max-w-[480px] text-[16px] leading-[1.62] text-ash text-pretty sm:text-[17.5px]">
